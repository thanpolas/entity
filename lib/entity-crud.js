...
var EntityCrud = module.exports = Entity.extend(function() {
  ...
  // Add event emissions
  this.create.last(this._emit.bind(this, 'create'));
  this.update.last(this._emit.bind(this, 'update'));
...
/**
 * Internal event emission method for Create and Update ops.
 *
 * @param {string} operation The op performed.
 * @param {*...} args Any number and type of arguments.
 * @private
 */
EntityCrud.prototype._emit = function() {
